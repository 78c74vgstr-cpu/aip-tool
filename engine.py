...
return CellRichText(blocks)  # ← FIXED: was indented with 3 spaces, now 4
```
...
1. change_type  — one of: “modified”, “new”, “deleted”
1. changed_columns — list of AIP column names that changed. Use EXACT names from the list above.
...
1. soc_text     — the full original change description, word for word, do not shorten.
